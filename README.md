...
The panel holds the CV as editable HTML, and a **Download CV** button serves
`assets/cv/Marlon_Steiner_CV.pdf`. That file is generated by
[`scripts/mkcv.py`](scripts/mkcv.py) from the same content, without the phone
number — see [`assets/cv/README.md`](assets/cv/README.md).
